...
public class ErrorReporter {
    ...
    public void reportError(Level level, String message, Throwable t) {
        LOGGER.log(level, message, t);
        // user doesn't need to know about WARNs
    ...
    private Alert initAlert(String message, Throwable t) {
     ...
     *     {@link Throwable}
     */
    public BiConsumer<Object, @Nullable Throwable> bind(Level level, String message) {
        return (value, t) -> {
            if (t != null) {
