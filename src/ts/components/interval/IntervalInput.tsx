...
import {exhaustiveCheck, oKeys} from "../../utils";
...
const RR_FREQUENCY_TO_GP: Record<Frequency, GeneralPeriod> =
    oKeys(GP_TO_RR_FREQUENCY)
        .reduce((agg, k) => {
                agg[GP_TO_RR_FREQUENCY[k]] = k;
                return agg;
            },
            {} as Record<Frequency, GeneralPeriod>);
...
export const IntervalInput: React.FC<IntervalInputProps> = ({interval, setInterval, ...props}) => {
